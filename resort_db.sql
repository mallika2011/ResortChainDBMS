...
VALUES
  ('1', '2', '2', '2019-12-18', '2019-12-28', 5000),('2', '2', '1', '2019-12-13', '2019-12-20', 5600);
UNLOCK TABLES;
...
CREATE TABLE RECREATION (
    Hotel_ID varchar(4) NOT NULL,
    Service_Provider char(15) NOT NULL,
...
INSERT INTO HOTEL_I
VALUES
  (FALSE, TRUE, 'Studio', 300, '1', '1'),(TRUE, TRUE, 'Duplex', 500, '2', '1'),(NULL, FALSE, 'Studio', 500, '1', '2'),(TRUE, TRUE, 'Duplex', 800, '2', '2');
UNLOCK TABLES;
...
CREATE TABLE FACILITIES_AVAILED (
    ...
    CONSTRAINT FACILITIES_AVAILED_ibfk_2 FOREIGN KEY (Member_ID) REFERENCES MEMBER (Member_ID)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8;
